    ...
    <div className="space-y-4 pb-20">
      ...
      <div className="bg-slate-800 rounded-xl p-4">
        <div className="flex items-center justify-between">
          ...
          <div className={`w-12 h-12 rounded-full flex items-center justify-center ${homeCount > 0 ? 'bg-green-500/20' : 'bg-slate-700'}`}>
            <svg className={`w-6 h-6 ${homeCount > 0 ? 'text-green-400' : 'text-slate-500'}`} viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="space-y-3">
        {sortedPeople.map(person => {
          ...
          return (
            <div key={person.entity_id} className="bg-slate-800 rounded-xl p-4">
              <div className="flex items-center gap-4">
                {/* Avatar */}
                <div className={`w-14 h-14 rounded-full flex items-center justify-center overflow-hidden ${isHome ? 'ring-2 ring-green-400 ring-offset-2 ring-offset-slate-800' : ''}`}>
              ...
              {person.attributes.source && (
                <div className="mt-3 pt-3 border-t border-slate-700/50 flex items-center gap-4 text-sm text-slate-500">
