...
export function EntityControlModal({ isOpen, onClose, title, children }: EntityControlModalProps) {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="w-full max-w-lg glass-card rounded-t-2xl rounded-b-none border-b-0 shadow-glass-lg animate-slide-up"
        style={{
      ...
      >
        ...
        {/* Content */}
        <div className="p-4 pb-8 max-h-[70vh] overflow-y-auto scrollbar-hide">
          {children}
        </div>
      </div>
