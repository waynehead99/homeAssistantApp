      ...
      <div className="max-w-3xl mx-auto flex justify-around relative">
        {primaryTabs.map((tab) => {
          ...
          return (
            ...
            >
              <div className={`transition-all duration-300 ${isActive ? 'drop-shadow-[0_0_8px_rgba(59,130,246,0.4)]' : ''}`}>
                {tab.icon(isActive)}
              </div>
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className={`flex flex-col items-center py-2 px-4 min-w-[64px] transition-all duration-300 ${
              isSecondaryActive || showMore ? 'text-blue-600' : 'text-slate-400 hover:text-slate-600'
            }`}
          >
            <div className={`transition-all duration-300 ${isSecondaryActive ? 'drop-shadow-[0_0_8px_rgba(59,130,246,0.4)]' : ''}`}>
